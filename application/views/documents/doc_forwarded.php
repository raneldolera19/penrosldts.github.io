...
<?php
				...
				if(isset($error)){
					...
					if($error=43){ echo 'The document was forwarded already! </h3></div>';
				}}
								 ...
								 <script type="text/javascript">  
												  $(document).ready(function() {  
													...
													<?php  $routeSecID= $doc ['route_tosection_id']; ?>  													
													 ...
													 <tr > <td> Route Purpose </td> <td> <textarea class="form-control" name="fwd_remarks" rows="3" style="width: 400px;"  ><?php echo $doc ['route_purpose']; ?></textarea>																								 
													 </td>
													 </tr>
