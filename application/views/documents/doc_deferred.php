            ...
            <div class="box-body">
              ...
              <table id="data_one" class="table table-bordered table-hover">
				...
				<!--  <th  ><div align="center">Date & Time Forwarded </div></th>-->
				  ...
				  <th width=20%>REASONS TO DEFER</th>
				...
				<td><?php echo $doc ['doctype_description']; ?><br> <?php echo $doc ['docs_description']; ?>
				 ...
				 <?php  if($doc ['accepting_remarks'] != ""){
					...
					if($doc ['fwd_remarks'] != ""){
						...
						echo $doc ['fwd_remarks']. '</font></small> <br>';
					}
					...
					<td>
					<?php echo $doc ['def_reason'];   ?><br><small>
					<?php echo viewtime($doc ['def_datetime']);   ?>
					</small>
					</td>
				...
				<div class="modal fade" id="action<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/documents/forwarding_actions');?>
													...
													<tr><td width=25%> Actions Taken</td><td><input type="text" class="form-control" name="actions" rows="3" style="width: 400px;" placeholder="Actions Taken ..."  required ></td></tr>  
													 ...
													 <tr><td> Route to :</td><td>
															<?php if(isset($all_othersections)){?>  
															   <select name="office_id" id="sectionsDrop<?php echo $doc ['action_id'];  ?>" class="form-control" style="width: 400px;" required>
													 ...
													 <tr > <td> Personnel  </td>													 
													 <td> 
													 <select name="users_id" id="usersDrop<?php echo $doc ['action_id'];  ?>" class="form-control" style="width: 400px;" required >																			 
													</select>																										 
													 </td>
													 </tr>
													 <tr > <td> Route Purpose </td> <td> <textarea class="form-control" name="fwd_remarks" rows="3" style="width: 400px;"  > </textarea>																								 
													 </td>
													 </tr>
				...
				<div class="modal fade" id="forfile<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/documents/keepfile_actions');?>
													...
													<small> There is no need to route or forward this document. I will keep the file.</small>	
													  ...
													  <div class="modal-body">
													<table class="table ">
													<tr><td width=20%> Actions Taken</td><td>
													
													<input type="text" class="form-control" name="actions" style="width: 400px;" placeholder="Your actions taken."  required >
				...
				<div class="modal fade" id="forrelease<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/documents/forrelease_actions');?>
													...
													<br> <small> Document Origin From : <?php echo $doc ['origin_fname']; ?> </small>
													  ...
													  <div class="modal-body">
													<table class="table ">
													<tr><td width=25%> Actions Taken</td><td><input type="text" class="form-control" name="actions" rows="3" style="width: 400px;" placeholder="Actions taken by your section"  required ></td></tr>  
													 <tr><td> Document Copy</td><td>
														 <select name="doc_copy" class="form-control" style="width: 400px;" required>
															<option style="visibility: hidden; display: none;" value='' >--Select--</option>
															<option value=0> NO, I don't retain copy of this document. </option>	
													 ...
													 <tr><td> Release to :</td><td>
														<input type="text" class="form-control" name="release_to" rows="3"  style="width: 400px;" placeholder="Full Name"  required >	
													 </td> </tr>
													 <tr > <td> Logbook Page Number  </td>													 
													 <td> 
													 <input type="text" name="logbookpage"  style="width: 400px;" class="form-control" >																			 
...
<div class="col-md-8">	
          ...
          <h4>No Deferred Documents</h4>
        </div></div>
		  <!-- Application buttons -->	  
	 <?php $this->load->view('documents/components/doc_application_buttons.php'); ?>   
