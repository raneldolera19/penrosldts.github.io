            ...
            <div class="box-body">
              ...
              <table id="data_one" class="table table-bordered table-hover">
				...
				<th width=8%>Tracking</th>
				 ...
				 <th width=10%>FWD From</th>
                 
				  <th >ACTIONS NEEDED</th>
                  <th width=20% ><div align="center">Date & Time Forwarded </div></th>
				...
				<div class="modal fade" id="acceptroute<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/documents/accept_routes');?>
													<div class="modal-content">
													  ...
													  <tr> <td width=30%>Tracking Number  </td> <td><b> <?php echo $doc ['doc_tracking']; ?></b>
														...
														<textarea style="width: 400px;" class="form-control" name="docs_description" rows="3" disabled > <?php echo $doc ['docs_description']; ?> </textarea>
														</td ></tr>
														<tr> <td> Actions Needed </td> <td>  <?php echo $doc ['route_purpose']; ?></td ></tr>
													    <tr> <td> Accepted by </td> <td> <?php echo $myprofile['fullname']; ?> </td ></tr>
														<tr> <td> Receiving Remarks </td> <td>  <textarea style="width: 400px;" class="form-control" name="accepting_remarks" rows="3"  > </textarea></td ></tr>
													  </table>
