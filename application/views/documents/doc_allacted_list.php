...
<?php
 ...
 <div class="row">
	...
	<?php if (isset($alldocs)){	?>		
		...
		<h4>	All Acted Document List (up to the recent 1800 documents) </h4>
            ...
            <div class="box-body">
              ...
              <table id="data_one" class="table table-bordered table-hover">
				...
				<th width=10%>Tracking</th>
				 <th width=18%>DOC TYPE & DETAIL</th>
			...
			<a href="<?php echo base_url().'documents/duplicate_route/'.$doc ['action_id'] ; ?>"	<button type="button" class="btn btn-info">Route Duplicate</button> </a>
