...
<?php
 ...
 <div class="row">
	...
	//	echo $docdet['docs_description'];
		...
		<td align="right"><a href="<?php echo base_url().'documents/edit_document/'.$docdet ['doc_id'] ; ?>" > <i class="fa fa-pencil-square-o" > Edit  </i> 	 	</a></td>
		<?php }?>
		</tr>
		</table>
...
<?php 
if($myprofile['system_admin']==1){
 echo 'Route ID: '.$doc ['action_id'].'<br>' ;
}
 //echo ' From: '. $doc ['route_from'].'<br> To: ';
 ...
 } else { echo '<strong><font color ="red"> Not yet received </font></strong> <br>';}
 if ($doc ['route_accomplished']==2 || $doc ['route_accomplished']==3){?>
 <hr>
	<a href="<?php echo base_url().'documents/re_entry/'.$doc ['action_id'] ; ?>"	<button type="button" class="btn btn-warning">Re-entry</button> </a>
