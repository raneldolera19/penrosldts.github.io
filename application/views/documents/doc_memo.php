  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Submit Memo</li>
...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Submit Memo  </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			...
			<div class="form-group">
				...
				<div class="form-group">
                  <label for="document type" class="col-sm-3 control-label">Memo Type</label>

                  <div class="col-sm-8">
				<!-- <input type="text" class="form-control" name="doc_type" value="Memo" required>-->
                 <select name="doc_type"  class="form-control" required>
							<option style="visibility: hidden; display: none;" value='' >-- Select Memo Type--</option>
							<option value="Central Office Memo"  > Central Office Memo</option>
							<option value="Regional Office Memo"  > Regional Memo</option>
							<option value="Division Office Memo"  > Division Memo</option>
							<option value="Other Memo"  > Other Memo</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="doc_description" placeholder="Memo Subject or Title " required>
                  </div>
                </div>
                <div class="form-group">
