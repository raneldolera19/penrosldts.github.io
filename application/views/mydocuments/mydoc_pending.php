		...
		<h4>	DOCUMENT PENDING FOR ACTION </h4>
            ...
            <div class="box-body">
              ...
              <table id="data_twoa" class="table table-bordered table-hover">
                ...
                <tr>
				<td><strong><a href="<?php echo base_url().'mydocuments/track_view/'.$doc ['doc_tracking'] ; ?>"><?php echo $doc ['doc_tracking']; ?></a></strong> </td>
				...
				<div class="modal fade" id="action<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/mydocuments/forwarding_actions');?>
													...
													<tr><td width=25%> Actions Taken</td><td><input type="text" class="form-control" name="actions" rows="3" placeholder="Actions Taken ..."  required ></td></tr>  
													 <tr><td> Document Copy</td><td>
														 <select name="doc_copy" class="form-control" required>
				...
				<div class="modal fade" id="forfile<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/mydocuments/keepfile_actions');?>
													<div class="modal-content">
													  <div class="modal-header">
													...
													<small> There is no need to route or forward this document. I will keep the file.</small>	
													  ...
													  <div class="modal-body">
													<table class="table ">
													<tr><td width=20%> Actions Taken</td><td><input type="text" class="form-control" name="actions" rows="3" placeholder="Your actions taken."  required ></td></tr>  
				...
				<div class="modal fade" id="forrelease<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/mydocuments/forrelease_actions');?>
													<div class="modal-content">
													  <div class="modal-header">
													...
													<br> <small> Document Origin From : <?php echo $doc ['origin_fname']; ?> </small>
													  ...
													  <div class="modal-body">
													<table class="table ">
													<tr><td width=25%> Actions Taken</td><td><input type="text" class="form-control" name="actions" rows="3" placeholder="Actions taken by your section"  required ></td></tr>  
													 <tr><td> Document Copy</td><td>
														 <select name="doc_copy" class="form-control" required>
															<option style="visibility: hidden; display: none;" value='' >--Select--</option>
															<option value=0> NO, I don't retain copy of this document. </option>	
													 ...
													 <tr><td> Release to :</td><td>
														<input type="text" class="form-control" name="release_to" rows="3" placeholder="Full Name"  required >	
													 </td> </tr>
													 <tr > <td> Logbook Page Number  </td>													 
													 <td> 
													 <input type="text" name="logbookpage"  class="form-control" >																			 
				...
				<div class="modal fade" id="fordefer<?php if (isset($doc ['action_id'])){ echo $doc ['action_id'];  }?>"tabindex="-1" role="dialog">
											...
											<?php echo form_open(base_url().'index.php/mydocuments/fordeferred_actions');?>
													<div class="modal-content">
													  <div class="modal-header">
													...
													<table class="table ">
													 ...
													 <tr><td> Reason/s  :</td><td>
														<td> <textarea class="form-control" name="def_reason" rows="3" required=required > </textarea>
													 </td> </tr>
