          ...
          <div class="box">
            ...
            <div class="box-body">
             ...
             <!-- <a href="<1?php echo base_url(); ?>index.php/mydocuments/receiving" class="btn btn-app">
			  ...
			  <a href="<?php echo base_url(); ?>index.php/mydocuments/deferred" class="btn btn-app">
			  <span class="badge bg-orange"><?php echo $deferredCount; ?></span>
			  ...
			  <a href="<?php echo base_url(); ?>mydocuments/all_acted" class="btn btn-app">
