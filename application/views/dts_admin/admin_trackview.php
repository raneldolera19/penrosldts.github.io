...
<?php
 ...
 <div class="row">
	...
	//	echo $docdet['docs_description'];
		...
		<tr> <td valign="top">   </td>
		<?php if($myprofile['dts_admin']==1){ ?>
		<td align="right">
		<a class="btn btn-primary" href="<?php echo base_url().'dts_admin/edit_document/'.$docdet ['doc_id'] ; ?>" > <i class="fa fa-pencil-square-o" > Edit  </i> 	 	</a>
		<a class="btn btn-warning" data-toggle="modal" data-target="#removeModal"  ><i class="fa fa-recycle" > Delete </i></a>
		</td>
		<?php }?>
		</tr>
		</table>
...
<?php 
 ...
 echo 'Route ID: '.$doc ['action_id'].'<br>' ;
...
<div id="removeModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
	...
	<?php 		echo form_open(base_url().'dts_admin/submit_delete_document');	?>	
	 ...
	 <p>Are you sure you want to delete this document including its routes?</p>
	 
	<p> Reason :
	 <textarea name="del_reason" class="form-control" required></textarea>
	 
	 <input type="hidden" name="doc_id" valu e="<?php echo $doc ['doc_id']; ?> ">
	 <input type="hidden" name="myuser_id" value="<?php echo $myprofile ['users_id']; ?> ">
      </div>
