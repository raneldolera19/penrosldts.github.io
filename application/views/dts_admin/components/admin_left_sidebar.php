 ...
 <!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
	  ...
	  <?php echo form_open(base_url().'dts_admin/search_track');?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
		 ...
		 <li>
          <a href="<?php echo base_url(); ?>dts_admin/sections">
            <i class="fa  fa-sliders"></i> <span>Sections</span>
        ...
        <li>
          <a href="<?php echo base_url(); ?>dts_admin/users">
